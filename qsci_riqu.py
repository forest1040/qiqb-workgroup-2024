# https://github.com/QunaSys/quri-parts-qsci/blob/main/quri_parts_qsci/__init__.py
...
def qsci_riqu(
    ...
    #print("circuit:", circuits[0])
    # for g in circuits[0].gates:
    #     print(g)
    qasm = convert_to_qasm_str(circuits[0])
    job = backend.sample_qasm(qasm, n_shots=1000)
    result = job.result()
    # TODO: physical_virtual_mapping での入れ替え
    # "transpiler_info": {
    ...
    #     }
    # },
    meas_counts_list = [result.counts]
